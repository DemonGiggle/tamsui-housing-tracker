  ...
  <div class=\"wrap\">
    ...
    <section class=\"tab-panel\" data-panel=\"raw\">
      ...
      <section class=\"card\">
        <h2>資料說明</h2>
        <ul>
          <li><strong>public-baseline</strong>：不是假成交，也不是亂編的資料；它是根據當下可取得的公開資訊（例如社區均價、格局範圍、少量可用樣本、社區頁基準資訊）整理出的「月度基準點」，也是目前主要追蹤層。</li>
          <li>換句話說，baseline 不是逐筆成交事實，而是目前最適合長期追蹤的月度基準層：它保留每坪價位與房型水位，讓你先看每個月的大致價格位置與變化方向。</li>
          <li>因此目前專案方向已改成：優先蒐集每月 baseline，把社區 × 房型 × 月份的時間序列先做完整；是否再補強其他樣本，屬於後續加值，不是主線。</li>
